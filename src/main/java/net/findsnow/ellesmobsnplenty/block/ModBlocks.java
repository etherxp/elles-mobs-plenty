...
public class ModBlocks {
  ...
  public static final Block NEPHRITE_BLOCK = registerBlock("nephrite_block",
          new Block(AbstractBlock.Settings.copy(Blocks.EMERALD_BLOCK).sounds(BlockSoundGroup.NETHERITE)));
  public static final Block BLOSSOMING_LUCI_VINE = registerBlock("blossoming_luci_vine",
          new BlossomingLuciVineBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_LEAVES).sounds(BlockSoundGroup.CHERRY_LEAVES).nonOpaque().noCollision().ticksRandomly()
                  .pistonBehavior(PistonBehavior.DESTROY)));
  public static final Block GREEN_MUSHROOM_LAMP = registerBlock("green_mushroom_lamp",
          new GreenMushroomLampBlock(AbstractBlock.Settings.create().mapColor(MapColor.EMERALD_GREEN).sounds(BlockSoundGroup.FUNGUS).luminance(
  ...
  public static final Block BLUE_MUSHROOM_LAMP = registerBlock("blue_mushroom_lamp",
          new BlueMushroomLampBlock(AbstractBlock.Settings.create().mapColor(MapColor.DIAMOND_BLUE).sounds(BlockSoundGroup.FUNGUS).luminance(
                  state -> state.get(GreenMushroomLampBlock.CLICKED) ? 7 : 0)));
  ...
  public static final Block LUCI_FUNGUS_SHELF_BLOCk = registerBlock("luci_fungus_shelf_block",
          new LuciFungusShelfBlock(AbstractBlock.Settings.copy(Blocks.MUSHROOM_STEM).nonOpaque()));
  ...
  public static final Block CHRYSALIS_BLOCK = registerBlock("chrysalis_block",
          new ChrysalisBlock(AbstractBlock.Settings.copy(Blocks.HONEY_BLOCK).sounds(BlockSoundGroup.HONEY)));
  ...
  public static final Block CLOVER = registerBlock("clover_block",
          new CloverBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_LEAVES).noCollision()));
  ...
  new LuciPetals(AbstractBlock.Settings.copy(Blocks.PINK_PETALS).nonOpaque().noCollision()));


  // Mushrooms
  public static final Block LUCI_MUSHROOM = registerBlock("luci_mushroom_block",
          new LuciMushroomBlock(AbstractBlock.Settings.copy(Blocks.OAK_LEAVES).sounds(BlockSoundGroup.FUNGUS).nonOpaque().pistonBehavior(PistonBehavior.DESTROY).noCollision()));
  ...
  public static final Block HOLLOW_LUCI_LOG = registerBlock("hollow_luci_log",
          new HollowLuciLogBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_LOG).nonOpaque()));
  ...
  public static final Block LUCI_LEAVES = registerBlock("luci_leaves",
          new LuciLeavesBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_LEAVES).nonOpaque().mapColor(MapColor.EMERALD_GREEN)));
  public static final Block BLOSSOMING_LUCI_LEAVES = registerBlock("blossoming_luci_leaves",
          new BlossomingLuciLeavesBlock(AbstractBlock.Settings.copy(Blocks.CHERRY_LEAVES).nonOpaque().mapColor(MapColor.EMERALD_GREEN)));
