...
{
  NEPHRITE("nephrite", 36, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
    map.put(ArmorItem.Type.BOOTS, 3);
    map.put(ArmorItem.Type.LEGGINGS, 6);
    map.put(ArmorItem.Type.CHESTPLATE, 8);
    map.put(ArmorItem.Type.HELMET, 3);
  }), 14, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 2.6f, 0.1f, () -> Ingredient.ofItems(ModItems.NEPHRITE));
  ...
  public String getName() {
    return EllesMobsNPlenty.MOD_ID + ":" + this.name;
  }
